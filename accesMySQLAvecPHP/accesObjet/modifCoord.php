    ...
    <body style="background-color: #252525; color: #ECF0F1">
        <?php
            ...
            if (!isset($_POST['modif']))
            {
                ...
                $code = $id_connect->escape_string($_POST['code']);
            ...
            elseif (isset($_POST['nom']) && isset($_POST['adresse']) && isset($_POST['ville'])) {
                // ENRÉGISTREMENT
                $nom = $id_connect->real_escape_string($_POST['nom']);
                $adresse = $id_connect->real_escape_string($_POST['adresse']);
                $ville = $id_connect->real_escape_string($_POST['ville']);
                $mail = $id_connect->real_escape_string($_POST['mail']);
                $code = $id_connect->real_escape_string($_POST['code']);
